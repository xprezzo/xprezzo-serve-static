...
xprezzo-serve-static is a new middleware function for serving files from within a given root directory.
...
### Serving using xprezzo

#### Simple

This is a simple example of using xprezzo.
